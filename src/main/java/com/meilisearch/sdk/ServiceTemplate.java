...
public interface ServiceTemplate {
     ...
     *     the generic
     * @param <T> type of targetClass or {@link com.meilisearch.sdk.http.response.HttpResponse} when
     *     targetClass is null
     * @return the deserialized response of type targetClass or the {@link
     *     com.meilisearch.sdk.http.response.HttpResponse} if targetClass is null
     * @throws MeiliSearchRuntimeException as a wrapper of API or JSON exceptions
     */
    <T> T execute(HttpRequest<?> request, Class<?> targetClass, Class<?>... parameter)
