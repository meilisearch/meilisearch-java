...
public class GenericServiceTemplate implements ServiceTemplate {
     ...
     */
    public GenericServiceTemplate(
            AbstractHttpClient client, JsonHandler processor, RequestFactory requestFactory) {
        this.client = client;
    ...
    public <T> T execute(HttpRequest<?> request, Class<?> targetClass, Class<?>... parameter)
