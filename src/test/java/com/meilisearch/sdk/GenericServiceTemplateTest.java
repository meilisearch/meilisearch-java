...
class GenericServiceTemplateTest {
    ...
    private final GenericServiceTemplate classToTest =
            new GenericServiceTemplate(client, handler, new BasicRequestFactory(handler));
    ...
    void executeGet() throws Exception {
        when(client.get(any(BasicHttpRequest.class)))
                .thenAnswer(
                        invocationOnMock -> {
                            BasicHttpRequest request = invocationOnMock.getArgument(0);
                            return new MockHttpResponse(
                                    request.getPath(), request.getHeaders(), request.getContent());
                        });
        BasicHttpRequest request =
                new BasicHttpRequest(HttpMethod.GET, "/path", Collections.emptyMap(), null);
    ...
    void executePost() throws Exception {
        ...
        BasicHttpRequest fullRequest =
                new BasicHttpRequest(HttpMethod.POST, "/path", Collections.emptyMap(), "content");
        ...
        MockHttpRequest contentlessRequest =
                new MockHttpRequest(HttpMethod.POST, "/path", Collections.emptyMap(), null);
    ...
    void executePut() throws Exception {
        ...
        BasicHttpRequest fullRequest =
                new BasicHttpRequest(HttpMethod.PUT, "/path", Collections.emptyMap(), "content");
        MockHttpResponse response = classToTest.execute(fullRequest, null);
        assertEquals(fullRequest.getPath(), response.getRequestPath());
        assertEquals(fullRequest.getContent(), response.getContent());
        assertEquals(fullRequest.getHeaders(), response.getHeaders());
        ...
        MockHttpRequest contentlessRequest =
                new MockHttpRequest(HttpMethod.PUT, "/path", Collections.emptyMap(), null);
        response = classToTest.execute(contentlessRequest, null);
        assertEquals(contentlessRequest.getPath(), response.getRequestPath());
        assertNull(response.getContent());
        assertEquals(contentlessRequest.getHeaders(), response.getHeaders());
    ...
    void executeDelete() throws Exception {
        ...
        BasicHttpRequest fullRequest =
                new BasicHttpRequest(HttpMethod.DELETE, "/path", Collections.emptyMap(), "content");
        MockHttpResponse response = classToTest.execute(fullRequest, null);
        assertEquals(fullRequest.getPath(), response.getRequestPath());
        ...
        MockHttpRequest contentlessRequest =
                new MockHttpRequest(HttpMethod.DELETE, "/path", Collections.emptyMap(), null);
        response = classToTest.execute(contentlessRequest, null);
        assertEquals(contentlessRequest.getPath(), response.getRequestPath());
        assertNull(response.getContent());
        assertEquals(contentlessRequest.getHeaders(), response.getHeaders());
    ...
    void defaultBranch() {
        assertThrows(
                ...
                () ->
                        classToTest.execute(
                                new MockHttpRequest(HttpMethod.HEAD, null, null, null), null));
    }
    ...
    public static class MockHttpResponse extends BasicHttpResponse {
        ...
        public MockHttpResponse(
                String requestPath, Map<String, String> requestHeaders, String requestBody) {
